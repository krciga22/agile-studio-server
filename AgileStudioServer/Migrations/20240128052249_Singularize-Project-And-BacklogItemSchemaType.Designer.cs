...
namespace AgileStudioServer.Migrations
{
    ...
    [Migration("20240128052249_test")]
    partial class SingularizeProjectAndBacklogItemSchemaType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgileStudioServer.Models.BacklogItemTypeSchema", b =>
                {
                    ...
                    b.HasIndex("ProjectID")
                        .HasDatabaseName("ix_backlog_item_type_schema_project_id");
            ...
            modelBuilder.Entity("AgileStudioServer.Models.BacklogItemType", b =>
                {
                    b.HasOne("AgileStudioServer.Models.BacklogItemTypeSchema", "BacklogItemTypeSchema")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_backlog_item_type_backlog_item_type_schema_id2");
            ...
            modelBuilder.Entity("AgileStudioServer.Models.BacklogItemTypeSchema", b =>
                {
                    b.HasOne("AgileStudioServer.Models.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_backlog_item_type_schema_project_project_id");
